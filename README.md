...
В `question_bank.json` лежит структурированный банк из 72 задач и вопросов. Часть банка - базовые продуктовые/ML-кейсы для ДЗ, часть - реальные или близкие к реальным интервью-задачи, извлеченные и переформулированные из PDF-подборок:
