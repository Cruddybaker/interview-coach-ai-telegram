...
Рабочий Telegram-прототип Interview Coach AI. Бот принимает резюме и вакансию, строит оценку готовности, показывает слабые места, подбирает вероятные вопросы и оценивает тренировочный ответ. Также поддерживает несколько резюме, выбор активного резюме и генерацию вопросов по позиции с учетом грейда.
...
- Несколько резюме: добавление, список и выбор активного резюме для вакансии.
...
Limited Go: технически ключевой сценарий работает, включая несколько резюме и вопросы по грейду, но перед MVP нужно добавить постоянную базу данных, провести 3 живых user-теста, расширить privacy-flow и сравнить результат с ручной подготовкой через ChatGPT.
